...
function sling.steps.SlingStepsMain:executeScript(args)
	if self:getDirectory() ~= nil then
		do _g.jk.fs.CurrentDirectory:set(self:getDirectory()) end
	else
...
function sling.steps.SlingStepsMain:getDirectory()
	do return self._directory end
end

function sling.steps.SlingStepsMain:doSetDirectory(value)
	self._directory = value
end

function sling.steps.SlingStepsMain:setDirectory(v)
	do self:doSetDirectory(v) end
	do return v end
end
