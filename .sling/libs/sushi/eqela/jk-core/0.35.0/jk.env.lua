...
function jk.env.CommonPath:getTemporaryDirectory()
	...
	_io:write_to_stdout("[jk.env.CommonPath.getTemporaryDirectory] (CommonPath.sling:44:3): Not implemented" .. "\n")
...
function jk.env.EnvironmentVariable:unset(key)
	_io:write_to_stdout("[jk.env.EnvironmentVariable.unset] (EnvironmentVariable.sling:145:2): Not implemented" .. "\n")
end
