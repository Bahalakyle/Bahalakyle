...
function jk.module.DynamicModule:forObject(ctx, oo)
	...
	_io:write_to_stdout("[jk.module.DynamicModule.forObject] (DynamicModule.sling:71:3): Not implemented." .. "\n")
	do return nil end
end
...
function jk.module.DynamicModule:loadFile(ctx, file)
	...
	_io:write_to_stdout("[jk.module.DynamicModule.loadFile] (DynamicModule.sling:162:3): Not implemented." .. "\n")
	do return false end
end

function jk.module.DynamicModule:executeStaticMethod(ctx, entityName, methodName, parameters)
	_io:write_to_stdout("[jk.module.DynamicModule.executeStaticMethod] (DynamicModule.sling:245:3): Not implemented." .. "\n")
	do return false end
end

function jk.module.DynamicModule:createObject(ctx, className)
	_io:write_to_stdout("[jk.module.DynamicModule.createObject] (DynamicModule.sling:318:3): Not implemented." .. "\n")
	do return nil end
end
