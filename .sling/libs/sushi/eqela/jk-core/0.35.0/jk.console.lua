...
function jk.console.ConsoleApplicationUtil:printHeader(writer, title, version, copyright, license, platform, component)
	...
	do
		...
		if sb:count() > 0 then
			do writer:print(sb:toString()) end
		end
	end
end

function jk.console.ConsoleApplicationUtil:printVersion(writer, version, title)
	if not (writer ~= nil) then
		do return end
	end
	if _g.jk.lang.String:isNotEmpty(title) then
		do writer:println(_g.jk.lang.String:safeString(title) .. "/" .. _g.jk.lang.String:safeString(version)) end
	else
		do writer:println(version) end
	end
end
	...
	if strings ~= nil then
		...
		do
			...
			while n < m do
				...
				if value ~= nil then
					local ss = _g.jk.lang.String:getLength(_g.jk.lang.String:asString(value[0 + 1])) + add
					if ss > v then
						v = ss
					end
				end
...
function jk.console.ConsoleApplicationMain:print(value)
	if self.stdout ~= nil then
		do self.stdout:print(value) end
	end
end

function jk.console.ConsoleApplicationMain:println(value)
	if self.stdout ~= nil then
		do self.stdout:println(value) end
	end
end
