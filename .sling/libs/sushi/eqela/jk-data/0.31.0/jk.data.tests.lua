...
function jk.data.tests.TestMain:_main(args)
	local v = true
	v = v and _g.jk.data.tests.SHAEncoderTests._construct0(_g.jk.data.tests.SHAEncoderTests._create()):execute()
	v = v and _g.jk.data.tests.MD5EncoderTests._construct0(_g.jk.data.tests.MD5EncoderTests._create()):execute()
	v = v and _g.jk.data.tests.Base64Tests._construct0(_g.jk.data.tests.Base64Tests._create()):execute()
	v = v and _g.jk.data.tests.CharacterDecoderTests._construct0(_g.jk.data.tests.CharacterDecoderTests._create()):execute()
...
function jk.data.tests.MD5EncoderTests:testMD5Encoder()
	if not (_g.jk.md5.MD5Encoder:encodeBuffer(_g.jk.lang.String:toUTF8Buffer("helloWorld")) == "1a833da63a6b7e20098dae06d06602e1") then
		_vm:throw_error(_g.jk.test.FailedAssertionException:instance("MD5EncoderTests.sling", "33", "2", nil))
	end
end

function jk.data.tests.MD5EncoderTests:execute()
	local v = true
	do _g.jk.log.Log:debug(self.ctx, "Executing test: " .. "MD5EncoderTests" .. " / " .. "MD5Encoder Method") end
	do
	...
	do _g.jk.log.Log:debug(self.ctx, "Done executing test: " .. "MD5EncoderTests" .. " / " .. "MD5Encoder Method") end
	do return v end
end
...
function jk.data.tests.Base64Tests:testBase64Encoding()
	...
	if not (_g.jk.base64.Base64Encoder:encodeString(str) == "SGVsbG8gV29ybGQ=") then
		_vm:throw_error(_g.jk.test.FailedAssertionException:instance("Base64Tests.sling", "34", "2", nil))
	end
end
...
function jk.data.tests.Base64Tests:testBase64Decoding()
	...
	if not (_g.jk.lang.String:forUTF8Buffer(decodedStr) == "Hello World") then
		_vm:throw_error(_g.jk.test.FailedAssertionException:instance("Base64Tests.sling", "42", "2", nil))
	end
end

function jk.data.tests.Base64Tests:execute()
	local v = true
	do _g.jk.log.Log:debug(self.ctx, "Executing test: " .. "Base64Tests" .. " / " .. "encode string") end
	do
		local _status, _err = _vm:execute_protected_call(function()
	...
	do _g.jk.log.Log:debug(self.ctx, "Done executing test: " .. "Base64Tests" .. " / " .. "encode string") end
	do _g.jk.log.Log:debug(self.ctx, "Executing test: " .. "Base64Tests" .. " / " .. "decode string") end
	do
		local _status, _err = _vm:execute_protected_call(function()
			do self:testBase64Encoding() end
		end)
	...
	do _g.jk.log.Log:debug(self.ctx, "Done executing test: " .. "Base64Tests" .. " / " .. "decode string") end
	do return v end
end
...
function jk.data.tests.CharacterDecoderTests:testCharacterDecoderMethods()
	...
	do
		...
		if not (dmap:getString("data", nil) == parse:getString("data", nil)) then
			_vm:throw_error(_g.jk.test.FailedAssertionException:instance("CharacterDecoderTests.sling", "37", "2", nil))
		end
	end
end
...
function jk.data.tests.CharacterDecoderTests:execute()
	local v = true
	do _g.jk.log.Log:debug(self.ctx, "Executing test: " .. "CharacterDecoderTests" .. " / " .. "CharacterDecoder Methods") end
	do
		local _status, _err = _vm:execute_protected_call(function()
	...
	do _g.jk.log.Log:debug(self.ctx, "Done executing test: " .. "CharacterDecoderTests" .. " / " .. "CharacterDecoder Methods") end
	do return v end
end
...
function jk.data.tests.SHAEncoderTests:testSHAEncoder()
	...
	if not (shaEncoder ~= nil) then
		_vm:throw_error(_g.jk.test.FailedAssertionException:instance("SHAEncoderTests.sling", "34", "2", nil))
	end
	if not (_g.jk.lang.Buffer:getSize(shaEncoder:encodeAsBuffer(_g.jk.lang.String:toUTF8Buffer("Hello World"), _g.jk.sha.SHAEncoder.SHA1)) == 20) then
		_vm:throw_error(_g.jk.test.FailedAssertionException:instance("SHAEncoderTests.sling", "35", "2", nil))
	end
	if not (_g.jk.lang.Buffer:getSize(shaEncoder:encodeAsBuffer(_g.jk.lang.String:toUTF8Buffer("Hello World"), _g.jk.sha.SHAEncoder.SHA256)) == 32) then
		_vm:throw_error(_g.jk.test.FailedAssertionException:instance("SHAEncoderTests.sling", "36", "2", nil))
	end
	if not (_g.jk.lang.Buffer:getSize(shaEncoder:encodeAsBuffer(_g.jk.lang.String:toUTF8Buffer("Hello World"), _g.jk.sha.SHAEncoder.SHA384)) == 48) then
		_vm:throw_error(_g.jk.test.FailedAssertionException:instance("SHAEncoderTests.sling", "37", "2", nil))
	end
	if not (_g.jk.lang.Buffer:getSize(shaEncoder:encodeAsBuffer(_g.jk.lang.String:toUTF8Buffer("Hello World"), _g.jk.sha.SHAEncoder.SHA512)) == 64) then
		_vm:throw_error(_g.jk.test.FailedAssertionException:instance("SHAEncoderTests.sling", "38", "2", nil))
	end
	if not (shaEncoder:encodeAsString(_g.jk.lang.String:toUTF8Buffer("Hello World"), _g.jk.sha.SHAEncoder.SHA1) == "0a4d55a8d778e5022fab701977c5d840bbc486d0") then
		_vm:throw_error(_g.jk.test.FailedAssertionException:instance("SHAEncoderTests.sling", "39", "2", nil))
	end
	if not (shaEncoder:encodeAsString(_g.jk.lang.String:toUTF8Buffer("Hello World"), _g.jk.sha.SHAEncoder.SHA256) == "a591a6d40bf420404a011733cfb7b190d62c65bf0bcda32b57b277d9ad9f146e") then
		_vm:throw_error(_g.jk.test.FailedAssertionException:instance("SHAEncoderTests.sling", "40", "2", nil))
	end
	if not (shaEncoder:encodeAsString(_g.jk.lang.String:toUTF8Buffer("Hello World"), _g.jk.sha.SHAEncoder.SHA384) == "99514329186b2f6ae4a1329e7ee6c610a729636335174ac6b740f9028396fcc803d0e93863a7c3d90f86beee782f4f3f") then
		_vm:throw_error(_g.jk.test.FailedAssertionException:instance("SHAEncoderTests.sling", "41", "2", nil))
	end
	if not (shaEncoder:encodeAsString(_g.jk.lang.String:toUTF8Buffer("Hello World"), _g.jk.sha.SHAEncoder.SHA512) == "2c74fd17edafd80e8447b0d46741ee243b7eb74dd2149a0ab1b9246fb30382f27e853d8585719e0e67cbda0daa8f51671064615d645ae27acb15bfb1447f459b") then
		_vm:throw_error(_g.jk.test.FailedAssertionException:instance("SHAEncoderTests.sling", "42", "2", nil))
	end
end

function jk.data.tests.SHAEncoderTests:execute()
	local v = true
	do _g.jk.log.Log:debug(self.ctx, "Executing test: " .. "SHAEncoderTests" .. " / " .. "SHAEncoder functions") end
	do
		local _status, _err = _vm:execute_protected_call(function()
	...
	do _g.jk.log.Log:debug(self.ctx, "Done executing test: " .. "SHAEncoderTests" .. " / " .. "SHAEncoder functions") end
	do return v end
end
